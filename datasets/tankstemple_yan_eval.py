...
class TanksTemple_MVSDatasetEval(Dataset):
    
    def __init__(self, datapath, listfile, mode, nviews, **kwargs):
        super(TanksTemple_MVSDatasetEval, self).__init__()
    ...
    def read_img(self, filename):
        ...
        # 1920*1080-->1920*1024
        np_img = cv2.resize(np_img,dsize=None,fx=1.0,fy=1024.0/1080.0,interpolation=cv2.INTER_LINEAR)
